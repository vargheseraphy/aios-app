...
/**
 * No newsletter backend exists yet (no email service is wired up anywhere
 * in this build — see DECISIONS.md's never-invent list), so this mirrors
 * home.html's own demo form: it prevents the default submit and does
 * nothing else, rather than pretending to subscribe anyone.
 */
