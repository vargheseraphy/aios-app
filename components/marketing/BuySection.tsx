...
/**
 * Ported verbatim from why-this-book.html / who-its-for.html's `.buy`
 * section — identical copy and markup on both, so shared here rather than
 * duplicated. Store links stay "#" with a visible note (see DECISIONS.md).
 */
export function BuySection() {
  return (
    <section className={styles.buy} id="get">
      <div className={styles.buyBg} />
      <div className={styles.buyLines} />
      <div className={`pad ${styles.buyIn}`}>
        ...
        <div className={styles.sellers}>
          <a className={styles.seller} href="#">
            ...
            <span>
              <b>Amazon</b>
              <span className={styles.sellerSub}>Paperback and Kindle — ships next day</span>
            </span>
          ...
          <a className={styles.seller} href="#">
            ...
            <span>
              <b>Notion Press</b>
              <span className={styles.sellerSub}>Direct from the publisher</span>
            </span>
            <span className={styles.sellerGo}>
              <svg className="i" width="18" height="18" viewBox="0 0 24 24">
                <path d="M5 12h14M13 6l6 6-6 6" />
          ...
          <a className={styles.seller} href="#bulk">
            <span className={styles.si}>
              <svg className="i" width="22" height="22" viewBox="0 0 24 24">
            ...
            <span>
              ...
              <span className={styles.sellerSub}>Ten copies or more, invoiced</span>
            </span>
            <span className={styles.sellerGo}>
              <svg className="i" width="18" height="18" viewBox="0 0 24 24">
                <path d="M5 12h14M13 6l6 6-6 6" />
